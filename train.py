...
# set path
data_path = "xxx"     # Follow UCF-101 RGB data path
...
#########Ranger优化器#########
optimizer = Ranger(crnn_params, lr=1e-3, alpha=0.5, k=6, N_sma_threshhold=5, betas=(.95,0.999), eps=1e-5, weight_decay=0)
